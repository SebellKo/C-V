...
description: Task-scoped implementation workflow for completing exactly one user-specified small task within one middle task. Use when the request explicitly references Spec/Task documents or MT/ST scope and the work should stop after marking the small task In Review.
---
...
9. When the middle task becomes `Done`, create a compact handoff under `docs/handoff/<current-branch-name>` using `docs/templates/handoff.md`.
